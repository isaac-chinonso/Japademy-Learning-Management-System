                    ...
                    <form action="#">
                        <div class="row gy-4">
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="text" class="form-control py-11" id="fname" placeholder="Enter First Name" value="{{ Auth::user()->profile->first()->fname }}">
                            </div>
                            <div class="col-sm-6 col-xs-6">
                                <label for="lname" class="form-label mb-8 h6">Last Name</label>
                                <input type="text" class="form-control py-11" id="lname" placeholder="Enter Last Name" value="{{ Auth::user()->profile->first()->lname }}">
                            </div>
                            <div class="col-sm-6 col-xs-6">
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <input type="number" class="form-control py-11" placeholder="Enter Phone Number" value="{{ Auth::user()->profile->first()->phone }}">
                            </div>
                            <div class="col-sm-6 col-xs-6">
                                <label for="phone" class="form-label mb-8 h6">Date of Birth</label>
                                <input type="text" class="form-control py-11" placeholder="Enter Date of Birth" value="{{ Auth::user()->profile->first()->dob }}">
                            </div>
                            <div class="col-sm-6 col-xs-6">
                                <label for="lname" class="form-label mb-8 h6">Gender</label>
                                <div class="position-relative">
                                    <select class="form-control py-11 ps-40" name="gender">
                                        <option value="{{ Auth::user()->profile->first()->gender }}">{{ Auth::user()->profile->first()->gender }}</option>
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <div class="position-relative">
                                    <select class="form-control py-11 ps-40" name="level">
                                        <option value="{{ Auth::user()->profile->first()->level }}">{{ Auth::user()->profile->first()->level }}</option>
                            ...
                            <div class="col-sm-6 col-xs-6">
                                ...
                                <div class="position-relative">
                                    <select class="form-control py-11 ps-40" name="address">
                                        <option value="{{ Auth::user()->profile->first()->address }}">{{ Auth::user()->profile->first()->address }}</option>
                            ...
                            <div class="col-12">
                                <div class="editor">
                                    ...
                                    <textarea class="form-control py-11 ps-40">{{ Auth::user()->profile->first()->bio }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
