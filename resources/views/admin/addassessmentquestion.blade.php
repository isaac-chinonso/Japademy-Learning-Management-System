...
@section('title')
Add Question to Skill Assessment || JapaDemy
@endsection
@section('content')
    ...
    <div class="breadcrumb-with-buttons mb-24">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Add Question to Skill Assessment</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
        <div align="right">
            <button type="button" class="bg-main-50 py-2 px-14 rounded-pill hover-bg-main-600">
                <a href="{{ url('/admin/skill-assessment') }}" class="text-white">
                    Go back to Skill Assessment Questions
                </a>
            </button>
        </div><br>
    </div>
    ...
    <div class="card overflow-hidden">
        <div class="card-body p-0">
            ...
            <form method="POST" action="{{ url('admin/save-skill-assessment-question') }}" style="padding:40px;">
                <h4 class="py-2 px-2">Add Question to Skill Assessment</h4>
                @csrf
                <div class="row gy-20">
