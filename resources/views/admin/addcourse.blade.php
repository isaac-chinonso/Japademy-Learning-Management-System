...
<div class="dashboard-body">
    ...
    <div class="breadcrumb-with-buttons mb-24">
        ...
        <div class="breadcrumb mb-24">
            <ul class="flex-align gap-4">
                ...
                <li><span class="text-main-600 fw-normal text-15">Add Courses</span></li>
            </ul>
        </div>
        <!-- Breadcrumb End -->
        <div align="right">
    ...
    <div class="card overflow-hidden">
        <div class="card-body p-0">
            <form method="POST" action="{{ url('admin/save-course') }}" enctype="multipart/form-data" style="padding:40px;">
            ...
            @csrf
                <div class="row gy-20">
                    ...
                    <div class="flex-align justify-content-end gap-8">
                        ...
                        <button type="submit" class="btn btn-main rounded-pill py-9">Submit Course</button>
                    </div>
                </div>
            </form>
        </div>
