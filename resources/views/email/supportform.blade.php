                                                        ...
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                    ...
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable">
                                                                            ...
                                                                            <table border="1">
                                                                                ...
                                                                                <tr style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                                                    <td>Name : </td>
                                                                                    <td>{{ $review->user()->profile->first()->fname }} {{ $review->user()->profile->first()->lname }}</td>
                                                                                </tr>
                                                                                <tr style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                                                    <td>Email: </td>
                                                            ...
                                                            <tr style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                                <td class="esd-block-text es-p20t" align="center">
                                                                    <h3 style="color: #333333;">Thank you, Japademy</h3>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                                        ...
                                                                        <tbody>
                                                                            <tr style="font-size: 14px;font-family: 'Harmattan', sans-serif;text-align:justify;">
                                                                                <td class="esd-block-text es-m-txt-c es-p5b" esdev-links-color="#777777" align="left">
                                                                                    <p style="color: #777777;"> © 2024
                                                                                        Japademy <br> You are receiving
                                                                                        this email because you signed up
                                                                                        on <a href="japademy.io" style="color:#aaaaaa">Japademy</a>. .<br></p>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
