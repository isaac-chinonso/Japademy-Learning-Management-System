                    ...
                    <div class="row align-items-center h-100">
                        <div class="col-lg-6">
                            <div class="grettings-box-two__content">
                                <h2 class="fw-medium mb-0 flex-align gap-10">
                                    Dear {{ Auth::user()->profile->first()->fname }}
                                    <img src="../assets-user/images/icons/wave-hand.png" alt="">
                                </h2>

                                @if($score && $level)
                                <p class="text-15 text-gray-400">
                                    Congratulations on completing the Japademy Africa Skill Assessment Test!<br><br>
                                    Based on your performance, you have been placed in the <strong>{{ $level }}</strong> category with the score <strong>{{ $score->score }}</strong>,
                                    which is a testament to your foundational understanding and potential for growth!<br><br>

                                @if ($level === 'Beginner')
                                <p style="font-weight: bold;">Start learning and exploring introductory courses to build your foundation.</p>
                                <a href="#" class="btn btn-main rounded-pill mt-32">Talk to an Advisor</a>
                                <a href="{{ route('learnerdashboard') }}" class="btn btn-main rounded-pill mt-32">Enroll Now in Recommended Program</a>
                                @elseif ($level === 'Intermediate')
                                <p style="font-weight: bold;">Great progress! Consider live training or reskilling opportunities to enhance your skills.</p>
                                <a href="#" class="btn btn-main rounded-pill mt-32">Talk to an Advisor</a>
                                <a href="{{ route('learnerdashboard') }}" class="btn btn-main rounded-pill mt-32">Enroll Now in Recommended Program</a>
                                @elseif ($level === 'Advanced')
                                <p style="font-weight: bold;">You’re doing well! Look into advanced certifications or apprenticeships to go global.</p>
                                <a href="#" class="btn btn-main rounded-pill mt-32">Talk to an Advisor</a>
                                <a href="{{ route('learnerdashboard') }}" class="btn btn-main rounded-pill mt-32">Enroll Now in Recommended Program</a>
                                @elseif ($level === 'Expert')
                                <p style="font-weight: bold;">Impressive skills! Career coaching with International workplace integration can take you further.</p>
                                <a href="#" class="btn btn-main rounded-pill mt-32">Talk to an Advisor</a>
                                <a href="#" class="btn btn-main rounded-pill mt-32">Enroll for International Coaching Program</a>
                                @elseif ($level === 'Genius')
                                <p style="font-weight: bold;">Outstanding! Global career advancement opportunities await you.</p>
                                <a href="#" class="btn btn-main rounded-pill mt-32">Talk to an Advisor</a>
                                <a href="#" class="btn btn-main rounded-pill mt-32">Enroll for International Coaching Program</a>
                                @endif
                                </p>
                                ...
                                @else
                                <p>No result found. Please take the assessment.</p>
                                @endif
                            </div>
