                        ...
                        <div class="col-lg-6">
                            <div class="grettings-box-two__content">
                                ...
                                <p class="text-15 text-gray-400">
                                    ...
                                    @if ($level === 'Beginner')
                                <p style="font-weight: bold;">Keep learning and exploring introductory courses to build your foundation.</p>
                                ...
                                @elseif ($level === 'Expert')
                                <p style="font-weight: bold;">Impressive skills! Career coaching and workplace integration can take you further.</p>
                                @elseif ($level === 'Genius')
