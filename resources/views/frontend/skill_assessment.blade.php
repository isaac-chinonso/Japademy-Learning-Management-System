                    ...
                    <div class="row align-items-center h-100">
                        <div class="col-lg-6">
                            <div class="grettings-box-two__content">
                                <h2 class="fw-medium mb-0 flex-align gap-10">Discover your Ideal Career Path with our Skill Assessment Test <img src="assets-user/images/icons/wave-hand.png" alt=""> </h2>
                                <p class="text-15 text-gray-400">👉 Answer series of questions to help find the perfect course for your career goals!<br><br> Unlock your potential with personalized course recommendations and certifications.</p>
                                <a href="{{ url('/start-skill-assessment') }}" class="btn btn-main rounded-pill mt-32">Start Now</a>
                            </div>
                        </div>
