                    ...
                    <form action="{{ route('scholarship.apply') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row gy-20">
                            ...
                            <div class="col-xxl-12 col-md-12 col-sm-12">
                                ...
                                <div class="row g-20">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control" name="country_of_residence" required>
                            ...
                            <div class="row g-20">
                                ...
                                <div class="col-sm-6">
                                    <label class="h6 mb-8 fw-semibold font-heading">Current Profession</label>
                                ...
                                <div class="col-sm-6">
                                    <label class="h6 mb-8 fw-semibold font-heading">Specialty</label>
